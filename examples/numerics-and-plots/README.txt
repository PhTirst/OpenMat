...
1. 首次打开 OpenMat，左侧 Current Folder 就是示例文件夹。
   位置是系统“文档”中的 OpenMat\Examples\0.1.7。
...
Documents\OpenMat\Examples\0.1.7 (the Windows Documents folder may be redirected).
...
计算与二维绘图
  ...
  discrete_signal.m        stem 茎状图与 stairs 阶梯图，比较离散采样和量化
  signal_energy_pie.m       用 fill 构造饼图，显示四个正弦分量的能量占比
...
饼图使用 fill 扇区与 legend 标签；当前尚未提供独立的 pie 函数。
